 ...
 * @group Components
 */
declare const PortableTextEditable: react5.ForwardRefExoticComponent<Omit<PortableTextEditableProps, "ref"> & react5.RefAttributes<Omit<HTMLDivElement, "as" | "onPaste" | "onBeforeInput">>>;
/** @beta */
...
declare const editorMachine: xstate77.StateMachine<{
  ...
  schema: EditorSchema;
  initialValue?: Array<PortableTextBlock>;
}, xstate77.NonReducibleUnknown, InternalPatchEvent | MutationEvent | PatchesEvent | {
  type: "blurred";
  event: react5.FocusEvent<HTMLDivElement, Element>;
} | {
  type: "done loading";
} | {
  type: "editable";
