 ...
 */
export function validateCorsOrigin(resource) {
    if (!resource)
        return [{ type: 'invalid_value', message: 'CORS Origin config must be provided' }];
    if (typeof resource !== 'object')
        return [{ type: 'invalid_type', message: 'CORS Origin config must be an object' }];
